...
//     setTimeout(() => {
//       // For demo purposes - in production, integrate with EmailJS, Formspree, or your backend
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Since mode is 'no-cors', we won't get a response
      ...
      setStatus({
        type: 'error',
        message: 'Failed to send message. Please try emailing directly at shashanksony82@gmail.com'
      });
    }
